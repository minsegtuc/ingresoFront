    ...
    return (
        <aside className={`bg-[#005CA2] text-white flex flex-col items-center text-sm lg:min-h-screen lg:max-h-screen lg:fixed`}>
            ...
            <div className='flex flex-col lg:mt-8 mt-2 w-full'>
                ...
                <NavLink to={'/ingreso/carga'} className={`w-full bg-[#f0f0f0] text-black border-t-2 border-b-2 py-2 flex justify-center hover:bg-black hover:text-white ${(rol === 'ENCARGADO') ? 'flex' : 'hidden'}`}>CARGA</NavLink>
            </div>
